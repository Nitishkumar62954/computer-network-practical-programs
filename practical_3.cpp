...
for(inti=0;i<aa;i=i+size+1)//to assign sequence no to frames
{
...
voidarivack(int y)//recieving acknowledgement
...
voidsdisplay()//displaying frames initially
